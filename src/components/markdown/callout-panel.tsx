...
export const CalloutPanel = ({ children, type, hideType = false }: Props) => {
  return (
    <div
      className={cx(
        'relative my-6 rounded-md px-8 pb-4 font-medium prose-p:my-2',
        hideType ? 'pt-4' : 'pt-5',
    ...
    >
      {!hideType && (
        <div
          className={cx(
            'jusitfy-center absolute -top-2 left-2 flex h-6 w-fit items-center rounded-md p-2 text-sm md:text-base lg:text-lg',
