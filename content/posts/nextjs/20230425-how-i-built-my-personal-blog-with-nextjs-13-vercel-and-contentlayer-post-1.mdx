...
summary: The process of how to build a blog with NextJS 13 App Directory, Vercel and Contentlayer. I'll be covering all of the details to get this setup and add some extra features!
publishedDate: 2023-04-25 17:02 UTC
topic: NextJS
tags:
  - NextJS
  - Vercel
...
If you aren't interesting in the background or the reasons that I chose to use; NextJS, Contentlayer and Vercel then you can skip to
...
This will be the first part in a series of posts on this topic, as soon as the next parts are available I will add links to them here.
...
- **Time investment:** One of the main downsides is the time investment, your time is valuable and if you have to spend time that you
  ...
  that could be seen as a waste of time. Building features from scratch to a good quality takes a lot of time & effort so you need to be
...
Put simply this package made it trivial to build your content including Markdown/MDX into an easily consumable and strongly typed format for
...
sites), but I have to say without a doubt using contentlayer has been game changing and demonstrates the accessibility and customization
...
As I personally use [Yarn][yarn-getting-started] in almost every project. All all of the examples shown will be using `yarn{:bash}` but all
...
<CalloutPanel type="info" hideType>
  ...
  *Edit:* This has been fixed with [v3.2.0][contentlayer-v320] of Contentlayer and this additional step should no longer be required.
</CalloutPanel>
